...
public class Jugador {
    ...
    @OneToMany(targetEntity = JugadorLesion.class, mappedBy = "jugador", cascade = CascadeType.REMOVE, fetch = FetchType.LAZY, orphanRemoval = true)
    private List<JugadorLesion> lesiones;
